(() => {
  ...
  function ensureAfterSales() {
    ...
    afterSalesPromise = loadScript("../data/after-sales-data.js?v=20260910-2").then(() => loadScript("../after-sales.js?v=20260910-2")).catch(error => {
