(() => {
  ...
  function ensureAfterSales() {
    ...
    afterSalesPromise = loadScript("../data/after-sales-data.js?v=20260910-1").then(() => loadScript("../after-sales.js?v=20260910-1")).catch(error => {
  ...
  function updateStatus(){if(workspace==="pre")$("#dataStatus").textContent=`售前 ${D.meta.sourceMin} 至 ${D.meta.sourceMax} · 各店共同完整至 ${D.meta.commonComplete} · 页面版本 v23`;else if(workspace==="weekly")$("#dataStatus").textContent="上周复盘 · 各模块按自身最新成熟周复盘 · 页面版本 v23";else if(workspace==="complaint"&&window.COMPLAINT_DATA)$("#dataStatus").textContent=`投诉登记 ${window.COMPLAINT_DATA.meta.sourceMin} 至 ${window.COMPLAINT_DATA.meta.sourceMax} · 最新完整周 ${window.COMPLAINT_DATA.meta.latestCompleteWeek} · 页面版本 v23`;else if(workspace==="returns"&&window.RETURN_REFUND_DATA)$("#dataStatus").textContent=`退货退款 ${window.RETURN_REFUND_DATA.meta.sourceMin} 至 ${window.RETURN_REFUND_DATA.meta.sourceMax} · 成熟月截止 ${window.RETURN_REFUND_DATA.meta.latestMatureMonth||"—"} · 页面版本 v23`;else if(window.AFTER_SALES_DATA)$("#dataStatus").textContent=`售后 ${window.AFTER_SALES_DATA.meta.afterSalesMin} 至 ${window.AFTER_SALES_DATA.meta.afterSalesMax} · 销售至 ${window.AFTER_SALES_DATA.meta.salesMax} · 页面版本 v23`;}
